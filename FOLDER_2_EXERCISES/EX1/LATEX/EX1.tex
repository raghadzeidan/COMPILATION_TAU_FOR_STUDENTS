...
object oriented language called Poseidon.
...
The input for the scanner is a single text file containing a Poseidon program,
...
\paragraph{Keywords} in Table \ref{Table_Reserved_Keywords_of_Poseidon} can \textit{not}
...
\end{tabular}
\caption{
Reserved keywords of Poseidon.
\label{Table_Reserved_Keywords_of_Poseidon}}
\end{table}
...
\paragraph{Comments} in Poseidon are similar to those used in the C programming language,
...
\end{tabular}
\caption{
Characters that may appear inside comments in Poseidon.
...
they are artificially limited in Poseidon to have
...
and then invite other team members, the course grader (ronshemer) and myself (OrenGitHub)
as collaborators.
