...
The semantics of binary operations in RioMare is therefore somewhat different
than that of standard programming languages.
Table \ref{Table_Binary_Operations_In_RioMare} uses a RioMare subscript
to distinguish its operators from theie usual mathematical meaning.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
                         &   & $-2^{15}$  &            &        & $a*b$ & $\leq$ & $-2^{15}$  \\
$ a ~ [*_{RioMare}] ~ b$ & = & $a*b$      & $-2^{15}$  & $\leq$ & $a*b$ & $\leq$ & $2^{15}-1$ \\
                         &   & $2^{15}-1$ & $2^{15}-1$ & $\leq$ & $a*b$ &        &            \\
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\hline
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
                         &   & $-32768$  & $a*b \leq -32768$            \\
$ a ~ [*_{RioMare}] ~ b$ & = & $a*b$     & $-32768 \leq a*b \leq 32767$ \\
                         &   & $-32768$  & $a*b \leq -32768$            \\
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\hline
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\hline
\end{tabular}
\caption{Binary Operations in RioMare
\label{Table_Binary_Operations_In_RioMare}}
\end{table}

$$
a ~ [*_{RioMare}] ~ b =
\begin{array}{lr}
a*b & a*b \in [-32768,32767] \\
a*b & a*b \in [-32768,32767] \\
\end{array}
$$  
ioMare programming language defines two native types: integers and strings.
